...
DataPath = fullfile(dataDir, 'ReconstructPWA');
filename_prefix = 'data_';

% Load raw data
Data_name = {fullfile(DataPath, 'PWA1.tif');
    fullfile(DataPath, 'PWA2.tif');
    fullfile(DataPath, 'PWA3.tif');
    fullfile(DataPath, 'PWA4.tif')};
